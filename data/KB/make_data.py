...
def main(args):
    ...
    if args.data == 'Wikidata':
        ...
        for file in os.listdir('./'):
            if file.startswith('wikidata5m_transductive_'):
                shutil.move(file, args.data)
        # shutil.move('wikidata5m_transductive_*.txt', args.data)
        # os.rename('wikidata5m_transductive_*.txt', args.data)
        # os.system(
        ...
        os.remove('wikidata5m_transductive.tar.gz')
        ...
        os.rename('fb3m/raw.txt', os.path.join(args.data, 'fb3m_triples.tsv'))
        os.rmdir('./fb3m/')
        # os.system("rm -r fb3m/")
