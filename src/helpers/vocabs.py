...
def load_pretrained_embeds(pretrain_embeds_file, embedding_dim):
    ...
    print('Loaded {}, {}-dementional pretrained word-embeddings\n'.format(len(pretrained), embedding_dim))
    return pretrained
...
class Words:
    """
    This class holding the vocabulary of a corpus and mapping from tokens to indices and vice versa.
    """
    ...
    def resize_vocab_maxsize(self, max_vocab_size):
        ...
        keep_words = list(high2low_freq.keys())[:max_vocab_size]
